...
def register():
    ...
    if form.validate_on_submit():
        encrypted_password = generate_password_hash(request.form.get("password"), method='pbkdf2:sha256', salt_length=8)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and check_password_hash(user.password, password):
            ...
            flash("Either your username or password do not exist.")
